                    ...
                    <form action="" className="register_form row" onSubmit={formik.handleSubmit}>
                        <div className="col-6">
                            <div className="form-group">
                                ...
                                <input type="text" className='form-control input_form' placeholder='Email' id='email'
                                       name='email'
                            ...
                            <div className="form-group">
                                ...
                                />
                                {formik.touched.psConfirm && formik.errors.psConfirm &&
                                    <p className='validate'>{formik.errors.psConfirm}</p>}
                            </div>
                        </div>
                        <div className="col-6">
                            <div className="form-group">
                                <label className='label_form' htmlFor="name">Name</label>
                                <input type="text" className='form-control input_form' placeholder='Name' id='name'
                                       name='name'
                                       onChange={formik.handleChange}
                                       onBlur={formik.handleBlur}
                            ...
                            <div className="form-group">
                                ...
                                <input type="text" className='form-control input_form' placeholder='Phone' id='phone'
                                       name='phone'
                                       onChange={formik.handleChange}
                                       onBlur={formik.handleBlur}
