...
import {profileFavoriteThunkAction, profileThunkAction} from '../../redux/redux-slides/userReduxSlides';
// scss
import './profile.scss'
//antd
...
import EmptyDataDisplay from '../../components/EmptyDisplay/EmptyDataDisplay';
import {getLocal} from '/src/utils/localStorage/index.js';
//constant
import {ACCESS_TOKEN} from '/src/const/index.js';
import GoLogin from '../../components/GoToLogin/GoLogin';
                    ...
                    <div className="information_area">
                        <div className="left_detail">
                            ...
                            <div className="action-avatar">
                                <input type="text" onChange={handleChangeAvaLink} placeholder='avatar URL'
                                       className='imgUrl'/>
                            ...
                            <div className="right_detail row">
                                <div className="col-6 col-right">
                                    <div className="form-group">
                                        ...
                                        <input type="text" className='form-control input_form' placeholder='Email'
                                               id='email' name='email'
                                        ...
                                        {formik.touched.email && formik.errors.email &&
                                            <p className='validate'>{formik.errors.email}</p>}
                                    </div>
                                    <div className="form-group">
                                        ...
                                        {formik.touched.password && formik.errors.password &&
                                            <p className='validate'>{formik.errors.password}</p>}
                                    </div>
                                </div>
                                <div className="col-6 col-right col-right-relative">
                                    <div className="form-group">
                                        <label className='label_form' htmlFor="name">Name</label>
                                        <input type="text" className='form-control input_form' placeholder='Name'
                                               id='name' name='name'
                                               onChange={formik.handleChange}
                                               onBlur={formik.handleBlur}
                                        ...
                                        {formik.touched.name && formik.errors.name &&
                                            <p className='validate'>{formik.errors.name}</p>}
                                    </div>
                                    <div className="form-group">
                                        <label className='label_form' htmlFor="phone">Phone</label>
                                        <input type="text" className='form-control input_form' placeholder='Phone'
                                               id='phone' name='phone'
                                               onChange={formik.handleChange}
                                               onBlur={formik.handleBlur}
                                        ...
                                        {formik.touched.phone && formik.errors.phone &&
                                            <p className='validate'>{formik.errors.phone}</p>}
                                    </div>
                                    <div className="radio-group">
                                        ...
                                        <div className="gender_choosen d-flex align-content-center">
                                            ...
                                            <div className="form-check">
                                                <label className="form-check-label lable_radio label_form text-center"
                                                       htmlFor="male">
                                            ...
                                            <div className="form-check">
                                                <label className="form-check-label lable_radio label_form"
                                                       htmlFor="female">
                                                    <input className="form-check-input" type="radio" name="gender"
                                                           id="female"
                                        ...
                                        <Space wrap>
                                            <Button className='btn_submit_login' shape='round'
                    ...
                    <div className="pill_tab">
                        <div>
                            <ul className="nav nav-tabs" id="myTab" role="tablist">
                                ...
                                <li className="nav-item" role="presentation">
                                    <button className="nav-link nav-link-2" id="profile-tab" data-toggle="tab"
                                            data-target="#profile" type="button" role="tab" aria-controls="profile"
                                            aria-selected="false">Favorite
                                    </button>
                                </li>
                            </ul>
                                    ...
                                    <div className="favorite_list row">
                                        {
                                            favoriteList.length > 0
                                                ? favoriteList?.map((item, index) => {
                                                    return (<div className="check" key={index}><CardProduct product={item}
                                                                                                            setChange={setChange}
                                                                                                            change={change}/>
                                                    </div>)
                                                })
